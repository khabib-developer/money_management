...
export default function ForgotPassword() {
   ...
   const onSubmit = async (data) => {
      setSent(await sendLinkToMail(data))
   }
   ...
   return (
       <div
          ...
          {
             sent ? <h4 className="mb-2.5 mt-32 text-4xl font-bold text-navy-700 dark:text-white">
                    Link for reset password sent to your email address, check your email address
                 </h4> :

        ...
        <ColumnChartCard />
         <div className="flex flex-col gap-5">
            <Dropdown
                ...
                children={
                   <div className="flex top  flex-col gap-2 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
                      {
                         Object.values( wallets ).map((wallet, i) => (
                             <div key={i} className="cursor-pointer px-2 rounded dark:text-white  hover:bg-gray-50 hover:dark:bg-gray-800">
